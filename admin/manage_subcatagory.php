...
<html>
    ...
    <body>
        ...
        <section>
            <h2 style="text-align: center;margin-bottom: 50px;">Manage Company</h2>
            <?php
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                $name = $_POST['category'];
                $subname = $_POST['name'];
                $query = "INSERT INTO sub_category(category_id,company_name)VALUES('$name','$subname')";
            ...
            <form action="" method="POST">
                <table width="50%">
                    ...
                    <td>
                        <input class="inputform"   type="text" name="name" placeholder="New Company" required>
