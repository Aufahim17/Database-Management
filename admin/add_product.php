...
<html>
    ...
    <body>
        ...
        <section>
            <h2 style="text-align: center;margin-bottom: 0; font-weight: bold;">Add New product</h2>
            <?php
                        ...
                        <td>
                            <select required name="subcategory">
                                ...
                                while ($subcategory = mysqli_fetch_assoc($result)) {
                                    ?>
                                    <option value="<?php echo $subcategory['id']; ?>"><?php echo $subcategory['company_name']; ?></option>
                                    <?php
                                }
                                ?>
                            </select>
