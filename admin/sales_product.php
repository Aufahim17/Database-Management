    ...
    ?>
            <form class="form" action="add_cart.php" method="POST">
                <table width="70%;" style="margin-left: 40px;">
                    ...
                    <tr>
                        ...
                        <td><input style="width: 87%" type="number" name="Quantity" placeholder="Quantity" required></td>
                    </tr>
            ...
            <tr>
                ...
                <td colspan="2"><?php echo $sum;?>TK</td>
                   ...
                   <button style="height: 10px; width: 100px;margin-left: 1150px; margin-bottom: 10px; background:white"><a href="confirm.php">CONFIRM</a></button>
            </div>
        </section>
        <footer>
