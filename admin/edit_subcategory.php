    ...
    <body>
        ...
        <section>
            ...
            if (isset($_POST['button'])) {
                ...
                $query = "UPDATE sub_category SET company_name='$name',category_id='$catid' where id='$subid'";
            ...
            <form action="edit_subcategory.php" method="POST">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    <center><table width="50%">
                            ...
                            <td><input  type="text" name="name" value="<?php echo $row['company_name']; ?>" required></td>
