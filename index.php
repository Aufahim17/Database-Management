...
<!--     <body style="background-image: url(sellers/img/bg.jpg )";> -->
                    ...
                    <center>
                        <table>
                            <tr>
                                ...
                                <td> <center><h1 style="margin: 0;font-family: Perpetua; color: silver">WELCOME</h1> <hr style="margin: 0; margin-bottom: 10px; width: 100px;"></center></td>
       ...
       if (isset($_GET['action'])){
           ...
           if($_GET['action']=='no'){
               echo "<span style='display:block;text-align:center; margin:2px; color:white;font-size:18px;'>Wrong Email or Password.</span>";
       }}
           ?>
                            <center>
                                <tr>
